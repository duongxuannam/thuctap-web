...
class KichHoatNhaTuyenDung extends Component {
    constructor(props) {
        super(props);
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" onChange={this.onChange} defaultValue={linhvuchoatdong} name="linhvuchoatdong">
...
export default connect(mapStateToProps, mapDispatchToProps)(KichHoatNhaTuyenDung);
