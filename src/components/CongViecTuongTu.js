            ...
            result = data.map((item, index) => {
                return (
                    <div class="job" key={index}>
                        <Link to={`/chitietcongviec/${item._id}`} onClick={() => { this.props.actChiTietCongViec(item._id) }} class="job-image">
                        ...
                        <div class="job-info">
                            <Link to={`/chitietcongviec/${item._id}`} onClick={() => { this.props.actChiTietCongViec(item._id) }}  class="job-title">{item.tieude}</Link>
                            ...
                            <div class="job-meta">
                                ...
                                <div class="job-meta-inner">
                                    <span class="badge badge-label-temp">  <Link to={`/chitietcongviec/${item._id}`} onClick={() => { this.props.actChiTietCongViec(item._id) }}>Chi tiết</Link></span>
                                </div>
                            </div>
                        </div>
                    </div>
